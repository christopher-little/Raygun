//==============================================================================
// Axis aligned bounding box utility functions, based on code by Moller
//
...
//==============================================================================
// Given a point and normal vector making a plane and the half side lengths of
// an axis aligned bounding box, return true if the plane overlaps the bounding
// box
// NOTE not a general purpose function, only useful when used from triBoxOverlap
// function
//==============================================================================
...
//==============================================================================
// Given the centre position of a axis aligned bounding box, the half length of
// each side and the vertices of a triangle (A, B, C), return true if the
